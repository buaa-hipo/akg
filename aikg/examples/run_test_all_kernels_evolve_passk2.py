...
from ai_kernel_generator.tools.single_evolve_runner import (
    EvolveConfig,
    print_evolve_config,
...
def parse_args():
    ...
    parser.add_argument("--max_rounds", type=int, default=5, help="最大进化轮次")
    ...
    parser.add_argument("--dsl", type=str, default="triton", help="DSL 类型")
