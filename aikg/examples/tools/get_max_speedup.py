...
if __name__ == '__main__':
    # base_dir = Path("/mnt/lustre-client/zhangzizheng/AIKG/akg/aikg/evolve_database/level1")
    base_dir = Path("/mnt/lustre-client/zhangzizheng/AIKG/save_data/gpt_5_5_a100/evolve_database/level1")
